...
public abstract class ItemRendererMixin {
    ...
    public BakedModel getHeldItemModelMixin(BakedModel bakedModel, @Local(argsOnly = true) ItemStack stack) {
        if (stack.getItem() == ModItems.HEAL_BEAM_2) {
            return this.models.getModelManager().getModel(ModelIdentifier.ofInventoryVariant(Identifier.of(Testmod10.MOD_ID, "heal_beam_2_3d")));
        }
