...
import com.omega4.testmod10.item.custom.HammerItem;
...
public class HammerUsageEvent implements PlayerBlockBreakEvents.Before{ //needs to be initialized / registered
    ...
    public boolean beforeBlockBreak(World world, PlayerEntity player, BlockPos pos,
        ...
        if(mainHandItem.getItem() instanceof HammerItem hammer && player instanceof ServerPlayerEntity serverPlayer) {
            ...
            for(BlockPos position : HammerItem.getBlocksToBeDestroyed(1, pos, serverPlayer)) {
                ...
                HARVESTED_BLOCKS.remove(position); //sus stuff with recursion
            }
        }
